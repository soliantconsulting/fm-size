...
fn test_logger_log_message() {
    ...
    let logger = Logger::new(&log_path).unwrap();
    logger.log_now("test_db", None, None, "Test message").unwrap();
...
fn test_logger_log_with_table() {
    ...
    let logger = Logger::new(&log_path).unwrap();
    logger.log_now("test_db", Some("test_table"), None, "Test message").unwrap();
...
fn test_logger_log_with_thread_id() {
    ...
    let logger = Logger::new(&log_path).unwrap();
    logger.log_now("test_db", None, Some(1), "Test message").unwrap();
...
fn test_logger_log_system_message() {
    ...
    let logger = Logger::new(&log_path).unwrap();
    logger.log_now("system", None, None, "System message").unwrap();
...
fn test_logger_write_blank_line() {
    ...
    let logger = Logger::new(&log_path).unwrap();
    logger.log_now("test_db", None, None, "First message").unwrap();
    logger.write_blank_line().unwrap();
    logger.log_now("test_db", None, None, "Second message").unwrap();
...
fn test_logger_append_mode() {
    ...
    logger1.log_now("test_db", None, None, "First message").unwrap();
    
    // Create a new logger instance - should append
    let logger2 = Logger::new(&log_path).unwrap();
    logger2.log_now("test_db", None, None, "Second message").unwrap();
