...
fn test_version_to_number() {
    ...
    assert_eq!(
        FMDeveloperTool::version_to_number("21.1.1"),
        21_000_100_010_000
    );
    assert_eq!(
        FMDeveloperTool::version_to_number("21.1.1.4"),
        21_000_100_010_004
    );
    assert_eq!(
        FMDeveloperTool::version_to_number("26.0.1"),
        26_000_000_010_000
    );
    assert_eq!(
        FMDeveloperTool::version_to_number("26.0.1.10"),
        26_000_000_010_010
    );
    assert_eq!(FMDeveloperTool::version_to_number("21"), 21_000_000_000_000);
    assert_eq!(
        FMDeveloperTool::version_to_number("21.1"),
        21_000_100_000_000
    );
}
...
fn test_version_to_number_invalid() {
    ...
    assert_eq!(
        FMDeveloperTool::version_to_number("21.invalid"),
        21_000_000_000_000
    );
}
...
fn test_parse_index_sizes_csv() {
    let csv = r#"
"FieldName","ValueIndexSize","Something","WordIndexSize","Extra"
"Field1","100","","200",""
"Field2","150","","250",""
"#;
...
fn test_parse_index_sizes_csv_missing_columns() {
    // This test checks that records with < 5 columns are skipped
    let csv = r#"
"FieldName","ValueIndexSize","Something","WordIndexSize","Extra"
"Field1","100","","",""
"#;
    ...
    assert_eq!(result[0].name, "Field1");
    assert_eq!(result[0].value_index_size_bytes, 100);
    assert_eq!(result[0].word_index_size_bytes, 0); // Missing word index defaults to 0
}
